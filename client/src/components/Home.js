...
import house from '../assets/images/outside.jpg';
                ...
                <section style={{backgroundColor: grey}}>
                    <Container className='p-4'>
                        ...
                        <Col md="auto" className="d-flex align-items-center justify-content-md-center">
                            <img src={house} alt="image of home" className="img-fluid w-75 w-sm-50 d-none d-sm-block" style={{ maxWidth: '550px', borderRadius:'49% 51% 52% 48% / 54% 55% 45% 46% ', opacity: '0.9', border: '4px solid #d4cdc4'}} />
                        </Col>
                        </Row>
                   </Container>
                   </section>
